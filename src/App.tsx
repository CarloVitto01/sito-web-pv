...
const ProtectedRoute: React.FC<{ element: JSX.Element; page: string }> = ({
  element,
  page,
}) => {
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/pdfPrint" element={<PdfPrintPage />} />
        ...
        <Route
          path="/bobine"
          element={<ProtectedRoute page="bobine" element={<BobinePLAGestionale />} />}
        />
        <Route
          path="/tasse"
          element={<ProtectedRoute page="tasse" element={<TasseGestionale />} />}
        />
        <Route
          path="/banner"
          element={<ProtectedRoute page="banner" element={<BannerGestionale />} />}
        />
        <Route
          path="/consegna"
          element={<ProtectedRoute page="consegna" element={<ConsegneGestionale />} />}
        />
        <Route
          path="/sconti"
          element={<ProtectedRoute page="sconti" element={<ScontiGestionale />} />}
        />
