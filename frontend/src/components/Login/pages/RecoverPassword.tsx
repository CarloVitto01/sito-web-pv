...
import { recoverPassword } from "../../../backend/auth";
...
export default function RecoverPasswordPage() {
  ...
  const handleRecover = async (e: React.FormEvent) => {
    ...
    try {
      await recoverPassword(telefono, email);
      setMessage("Se i dati sono corretti, riceverai a breve un'email di recupero. Controlla la tua casella di posta.");
    } catch {
